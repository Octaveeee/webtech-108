export default function Footer() {
  return (
    <footer className="w-full fixed bottom-0 left-0 z-10 bg-[#24252a]/95 backdrop-blur border-t border-gray-700 text-zinc-200">
      <div className="max-w-screen-xl mx-auto px-6 py-4">
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4 text-center md:text-left">
          <span className="text-sm max-w-md md:max-w-lg whitespace-normal break-words">
            Project developed as part of the Web Technologies course at ECE, ...
          </span>
